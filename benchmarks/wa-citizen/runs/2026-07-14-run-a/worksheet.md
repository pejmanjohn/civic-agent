# Tier 1 Worksheet - 2026-07-14-run-a
...
|---|---|---|---|
| `seattle-parks-2026-lookup` | 4/5 |  |  |
| `wa-checkbook-vendor-lookup` | 4/5 |  |  |
| `pierce-vs-king-per-resident` | 6/9 |  |  |
...
- `seattle-2026-deficit-jumpstart` / caveat:expenditure-side-only: expected 'States the accepted Seattle source is expenditure-side; JumpStart receipts-vs-allocations needs a revenue source.', got 'not found'
